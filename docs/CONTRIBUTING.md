...
# `sanger-tol/tiara_fcsgx_analysis`: Contributing guidelines

Hi there!
Thanks for taking an interest in improving sanger-tol/tiara_fcsgx_analysis.

This page describes the recommended nf-core way to contribute to both sanger-tol/tiara_fcsgx_analysis and nf-core pipelines in general, including:

- [General contribution guidelines](#general-contribution-guidelines): common procedures or guides across all nf-core pipelines.
- [Pipeline-specific contribution guidelines](#pipeline-specific-contribution-guidelines): procedures or guides specific to the development conventions of sanger-tol/tiara_fcsgx_analysis.
...
- [ ] Check whether a GitHub [issue](https://github.com/sanger-tol/tiara_fcsgx_analysis/issues) about your idea already exists. If an issue does not exist, create one so that others are aware you are working on it.
- [ ] [Fork](https://help.github.com/en/github/getting-started-with-github/fork-a-repo) the [sanger-tol/tiara_fcsgx_analysis repository](https://github.com/sanger-tol/tiara_fcsgx_analysis) to your GitHub account.
...
You can contribute to sanger-tol/tiara_fcsgx_analysis without installing a local development environment on your machine by using [GitHub Codespaces](https://github.com/codespaces).
...
To get started, open the repository in [Codespaces](https://github.com/sanger-tol/tiara_fcsgx_analysis/codespaces).
...
nf-core semi-standardises how you write code and other contributions to make the sanger-tol/tiara_fcsgx_analysis code and processing logic more understandable for new contributors and to ensure quality.
